  ...
  <div class="min-h-screen bg-white">
    ...
    <div class="print:hidden max-w-4xl mx-auto p-8 pb-0">
      <div class="card mb-6">
        <div class="card-header">
          <h3 class="font-semibold text-secondary-900">Filter Periode</h3>
        </div>
        <div class="card-body">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              <label class="label">Tanggal Akhir <span class="text-red-500">*</span></label>
              <input v-model="endDate" type="date" class="input" required />
            </div>
            <div class="flex items-end">
              <button @click="loadData" class="btn-primary w-full">Tampilkan</button>
            </div>
          </div>
        </div>
      </div>
    ...
    <div id="report-content" class="max-w-4xl mx-auto p-8">
      ...
      <div class="text-center mb-6 pt-4">
        ...
        <p class="text-gray-600 mt-1">Periode: {{ formatDate(startDate) }} s/d {{ formatDate(endDate) }}</p>
      </div>
