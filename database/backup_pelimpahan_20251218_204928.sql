...
\restrict mq0q4WMOTVNtJwFr3xONUwPmAQwiRrkPdKw8bjMnJGbnwPxZVfaghr3Z5koYdL7
...
--
-- Name: jenis_pelimpahans; Type: TABLE; Schema: public; Owner: pelimpahan
--
...
ALTER TABLE public.jenis_pelimpahans OWNER TO pelimpahan;

--
-- Name: jenis_pelimpahans_id_seq; Type: SEQUENCE; Schema: public; Owner: pelimpahan
--
...
ALTER SEQUENCE public.jenis_pelimpahans_id_seq OWNER TO pelimpahan;

--
-- Name: jenis_pelimpahans_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: pelimpahan
--
...
--
-- Name: pelimpahan_details; Type: TABLE; Schema: public; Owner: pelimpahan
--
...
ALTER TABLE public.pelimpahan_details OWNER TO pelimpahan;

--
-- Name: pelimpahan_details_id_seq; Type: SEQUENCE; Schema: public; Owner: pelimpahan
--
...
ALTER SEQUENCE public.pelimpahan_details_id_seq OWNER TO pelimpahan;

--
-- Name: pelimpahan_details_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: pelimpahan
--
...
--
-- Name: pelimpahans; Type: TABLE; Schema: public; Owner: pelimpahan
--
...
ALTER TABLE public.pelimpahans OWNER TO pelimpahan;

--
-- Name: pelimpahans_id_seq; Type: SEQUENCE; Schema: public; Owner: pelimpahan
--
...
ALTER SEQUENCE public.pelimpahans_id_seq OWNER TO pelimpahan;

--
-- Name: pelimpahans_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: pelimpahan
--
...
--
-- Name: penarikan_tunais; Type: TABLE; Schema: public; Owner: pelimpahan
--
...
ALTER TABLE public.penarikan_tunais OWNER TO pelimpahan;

--
-- Name: penarikan_tunais_id_seq; Type: SEQUENCE; Schema: public; Owner: pelimpahan
--
...
ALTER SEQUENCE public.penarikan_tunais_id_seq OWNER TO pelimpahan;

--
-- Name: penarikan_tunais_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: pelimpahan
--
...
--
-- Name: saldo_bendaharas; Type: TABLE; Schema: public; Owner: pelimpahan
--
...
ALTER TABLE public.saldo_bendaharas OWNER TO pelimpahan;

--
-- Name: saldo_bendaharas_id_seq; Type: SEQUENCE; Schema: public; Owner: pelimpahan
--
...
ALTER SEQUENCE public.saldo_bendaharas_id_seq OWNER TO pelimpahan;

--
-- Name: saldo_bendaharas_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: pelimpahan
--
...
--
-- Name: settings; Type: TABLE; Schema: public; Owner: pelimpahan
--
...
ALTER TABLE public.settings OWNER TO pelimpahan;

--
-- Name: settings_id_seq; Type: SEQUENCE; Schema: public; Owner: pelimpahan
--
...
ALTER SEQUENCE public.settings_id_seq OWNER TO pelimpahan;

--
-- Name: settings_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: pelimpahan
--
...
--
-- Name: top_up_saldos; Type: TABLE; Schema: public; Owner: pelimpahan
--
...
ALTER TABLE public.top_up_saldos OWNER TO pelimpahan;

--
-- Name: top_up_saldos_id_seq; Type: SEQUENCE; Schema: public; Owner: pelimpahan
--
...
ALTER SEQUENCE public.top_up_saldos_id_seq OWNER TO pelimpahan;

--
-- Name: top_up_saldos_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: pelimpahan
--
...
--
-- Name: units; Type: TABLE; Schema: public; Owner: pelimpahan
--
...
ALTER TABLE public.units OWNER TO pelimpahan;

--
-- Name: units_id_seq; Type: SEQUENCE; Schema: public; Owner: pelimpahan
--
...
ALTER SEQUENCE public.units_id_seq OWNER TO pelimpahan;

--
-- Name: units_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: pelimpahan
--
...
--
-- Name: users; Type: TABLE; Schema: public; Owner: pelimpahan
--
...
ALTER TABLE public.users OWNER TO pelimpahan;

--
-- Name: users_id_seq; Type: SEQUENCE; Schema: public; Owner: pelimpahan
--
...
ALTER SEQUENCE public.users_id_seq OWNER TO pelimpahan;

--
-- Name: users_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: pelimpahan
--
...
--
-- Name: jenis_pelimpahans id; Type: DEFAULT; Schema: public; Owner: pelimpahan
--
...
--
-- Name: pelimpahan_details id; Type: DEFAULT; Schema: public; Owner: pelimpahan
--
...
--
-- Name: pelimpahans id; Type: DEFAULT; Schema: public; Owner: pelimpahan
--
...
--
-- Name: penarikan_tunais id; Type: DEFAULT; Schema: public; Owner: pelimpahan
--
...
--
-- Name: saldo_bendaharas id; Type: DEFAULT; Schema: public; Owner: pelimpahan
--
...
--
-- Name: settings id; Type: DEFAULT; Schema: public; Owner: pelimpahan
--
...
--
-- Name: top_up_saldos id; Type: DEFAULT; Schema: public; Owner: pelimpahan
--
...
--
-- Name: units id; Type: DEFAULT; Schema: public; Owner: pelimpahan
--
...
--
-- Name: users id; Type: DEFAULT; Schema: public; Owner: pelimpahan
--
...
1	countdown	{"active":true,"description":"Penatausahaan Keuangan akan berakhira tanggal 31 Desember 2025","target_date":"2025-12-31T00:00","title":"Jadwal Penatausahaan Tahun 2025"}	2025-12-18 16:46:06.739945+08	2025-12-18 16:51:31.504975+08
2	branding	{"app_name":"Sistem Pelimpahan","app_subtitle":"Dana UP/GU","logo_url":"http://localhost:8000/uploads/logo_20251218171038.png"}	2025-12-18 17:10:40.094805+08	2025-12-18 17:27:47.727803+08
\.
...
3	Operator Input	operator@pelimpahan.local	$2a$10$d7UGOabDOTi.jYEpeDd8LOJq9KP.Vk5rCbbUyy8Ds.RMp/lAqNMUS	operator		t	2025-12-18 15:20:40.460935+08	2025-12-18 15:20:40.460935+08
1	Asriyanto	admin@pelimpahan.local	$2a$10$d7UGOabDOTi.jYEpeDd8LOJq9KP.Vk5rCbbUyy8Ds.RMp/lAqNMUS	super_admin	http://localhost:8000/uploads/avatar_20251218160705_admin_pelimpahan.local.png	t	2025-12-18 15:20:40.456917+08	2025-12-18 16:07:34.469932+08
2	Astuty Sulistiyanti, ST	bendahara@pelimpahan.local	$2a$10$d7UGOabDOTi.jYEpeDd8LOJq9KP.Vk5rCbbUyy8Ds.RMp/lAqNMUS	bendahara	http://localhost:8000/uploads/avatar_20251218165447_bendahara_pelimpahan.local.png	t	2025-12-18 15:20:40.459772+08	2025-12-18 16:54:48.963773+08
\.


--
-- Name: jenis_pelimpahans_id_seq; Type: SEQUENCE SET; Schema: public; Owner: pelimpahan
--
...
--
-- Name: pelimpahan_details_id_seq; Type: SEQUENCE SET; Schema: public; Owner: pelimpahan
--
...
--
-- Name: pelimpahans_id_seq; Type: SEQUENCE SET; Schema: public; Owner: pelimpahan
--
...
--
-- Name: penarikan_tunais_id_seq; Type: SEQUENCE SET; Schema: public; Owner: pelimpahan
--
...
--
-- Name: saldo_bendaharas_id_seq; Type: SEQUENCE SET; Schema: public; Owner: pelimpahan
--
...
--
-- Name: settings_id_seq; Type: SEQUENCE SET; Schema: public; Owner: pelimpahan
--
...
--
-- Name: top_up_saldos_id_seq; Type: SEQUENCE SET; Schema: public; Owner: pelimpahan
--
...
--
-- Name: units_id_seq; Type: SEQUENCE SET; Schema: public; Owner: pelimpahan
--
...
--
-- Name: users_id_seq; Type: SEQUENCE SET; Schema: public; Owner: pelimpahan
--
...
--
-- Name: jenis_pelimpahans jenis_pelimpahans_kode_jenis_key; Type: CONSTRAINT; Schema: public; Owner: pelimpahan
--
...
--
-- Name: jenis_pelimpahans jenis_pelimpahans_pkey; Type: CONSTRAINT; Schema: public; Owner: pelimpahan
--
...
--
-- Name: pelimpahan_details pelimpahan_details_pkey; Type: CONSTRAINT; Schema: public; Owner: pelimpahan
--
...
--
-- Name: pelimpahans pelimpahans_pkey; Type: CONSTRAINT; Schema: public; Owner: pelimpahan
--
...
--
-- Name: penarikan_tunais penarikan_tunais_pkey; Type: CONSTRAINT; Schema: public; Owner: pelimpahan
--
...
--
-- Name: saldo_bendaharas saldo_bendaharas_pkey; Type: CONSTRAINT; Schema: public; Owner: pelimpahan
--
...
--
-- Name: settings settings_key_key; Type: CONSTRAINT; Schema: public; Owner: pelimpahan
--
...
--
-- Name: settings settings_pkey; Type: CONSTRAINT; Schema: public; Owner: pelimpahan
--
...
--
-- Name: top_up_saldos top_up_saldos_pkey; Type: CONSTRAINT; Schema: public; Owner: pelimpahan
--
...
--
-- Name: units units_kode_unit_key; Type: CONSTRAINT; Schema: public; Owner: pelimpahan
--
...
--
-- Name: units units_pkey; Type: CONSTRAINT; Schema: public; Owner: pelimpahan
--
...
--
-- Name: users users_email_key; Type: CONSTRAINT; Schema: public; Owner: pelimpahan
--
...
--
-- Name: users users_pkey; Type: CONSTRAINT; Schema: public; Owner: pelimpahan
--
...
--
-- Name: pelimpahan_details fk_pelimpahan_details_unit; Type: FK CONSTRAINT; Schema: public; Owner: pelimpahan
--
...
--
-- Name: pelimpahans fk_pelimpahans_creator; Type: FK CONSTRAINT; Schema: public; Owner: pelimpahan
--
...
--
-- Name: pelimpahan_details fk_pelimpahans_details; Type: FK CONSTRAINT; Schema: public; Owner: pelimpahan
--
...
--
-- Name: pelimpahans fk_pelimpahans_jenis_pelimpahan; Type: FK CONSTRAINT; Schema: public; Owner: pelimpahan
--
...
--
-- Name: penarikan_tunais fk_penarikan_tunais_creator; Type: FK CONSTRAINT; Schema: public; Owner: pelimpahan
--
...
--
-- Name: saldo_bendaharas fk_saldo_bendaharas_creator; Type: FK CONSTRAINT; Schema: public; Owner: pelimpahan
--
...
--
-- Name: top_up_saldos fk_top_up_saldos_creator; Type: FK CONSTRAINT; Schema: public; Owner: pelimpahan
--
...
\unrestrict mq0q4WMOTVNtJwFr3xONUwPmAQwiRrkPdKw8bjMnJGbnwPxZVfaghr3Z5koYdL7
